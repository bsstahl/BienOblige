        ...
        var activity = new CreateActionItemActivitiesBuilder()
            ...
            .ActionItems(new ActionItemCollectionBuilder()
                .Add(new ActionItemBuilder() // TODO: Add prerequisite task (id is stored in dependentTaskId)
                    ...
                    .Content("Stage bus 1234 in lane C2 for departure at 06:15 MST", TestHelpers.DefaultMediaType)
                    .EndTime(stageByTime) // 06:15 AM Tomorrow
                    .Target(targetBusBuilder))
                .Add(new ActionItemBuilder()
                    .Id(dependentTaskId)
                    .Name("Perform daily inspection")
                    .Content("Perform daily inspection of bus 1234 prior to staging", TestHelpers.DefaultMediaType)
        ...
        var activities = new CreateActionItemActivitiesBuilder()
            ...
            .ActionItems(new ActionItemCollectionBuilder()
                .Add(new ActionItemBuilder()
                    ...
                    .Name("ActionItem_1")
                    .Content("ActionItem_1 content", TestHelpers.DefaultMediaType)
                    .AddCompletionMethod(Enumerations.CompletionMethod.AllChildrenCompleted)
                    .Children(new ActionItemCollectionBuilder()
                        .Add(new ActionItemBuilder()
                            .Id(Guid.NewGuid()) // TODO: Add content
                            .Name("ActionItem_2")
                            .Content("ActionItem_2: A child task of ActionItem_1", TestHelpers.DefaultMediaType)
                            ...
                            .Children(new ActionItemCollectionBuilder()
                                .Add(new ActionItemBuilder()
                                    .Name("ActionItem_3")
                                    .Content("ActionItem_3: A child task of ActionItem_2", TestHelpers.DefaultMediaType)
                                    .AddCompletionMethod(Enumerations.CompletionMethod.ParentCompleted))
                                .Add(new ActionItemBuilder()
                                    .Name("ActionItem_4")
                                    .Content("ActionItem_4: A child task of ActionItem_2", TestHelpers.DefaultMediaType)
                                    .AddCompletionMethod(Enumerations.CompletionMethod.ParentCompleted))
                    )))))
            .Build();
            ...
            var activities = new CreateActionItemActivitiesBuilder()
                ...
                .ActionItems(new ActionItemCollectionBuilder()
                    ...
                    .Add(new ActionItemBuilder()
                        ...
                        .Name("ActionItem_2")
                        .Content("ActionItem_2 content", TestHelpers.DefaultMediaType))
                    .Add(new ActionItemBuilder()
                        .Name("ActionItem_3")
                        .AddAdditionalProperty("shouldFail", true)
                        .Content("ActionItem_3 content", TestHelpers.DefaultMediaType))
                    .Add(new ActionItemBuilder()
                        .Name("ActionItem_4")
                        .Content("ActionItem_4 content", TestHelpers.DefaultMediaType)))
                .Build();
